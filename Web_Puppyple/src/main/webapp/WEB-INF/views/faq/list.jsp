	...
	<div id="content_wrap">
		...
		<div id="community_menubar">
			...
			<div class="notice_title_div">
				<h1 class="title">FAQ<span class="small_title"><span class="small_title_l">|</span> faq</span></h1>
			</div>
		</div>
				...
				<div class="list-content">
					...
					<c:forEach items="${page.list}" var="vo">
						<ul>
							...
							<li class="w-pct50"  style="text-align: left; padding-left: 70px; "><a href='detail.faq?id=${vo.id }'>${vo.board_title }</a></li>
