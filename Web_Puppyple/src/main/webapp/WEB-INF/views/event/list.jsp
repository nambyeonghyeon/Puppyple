	...
	<div id="content_wrap">
		...
		<div id="community_menubar">
			...
			<div class="notice_title_div">
				<h1 class="title">이벤트<span class="small_title"><span class="small_title_l">|</span> event</span></h1>
			</div>
		</div>
		...
		<div class="event_list">
			<ul class="grid">
					<li>
						<a href="event_detail1.ev">
							<div id="event_banner"><img src="imgs/puppypleevent1_banner.jpg" alt="puppyple_event"></div>
			...
			<ul class="grid">
				<li>
					<a href="event_detail2.ev">
						<div id="event_banner"><img src="imgs/puppypleevent2_banner.jpg" alt="puppyple_event"></div>
