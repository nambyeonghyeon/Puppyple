			...
			<div>
				...
				<div id="mp_wrap">
					<div id="checkForm">
						...
						<div class="form" >
							<label for="pw_check">비밀번호 입력</label>
							<input type="password" name="pw_check_leave" id="pw_check_leave" onkeypress = "if (event.keyCode == 13) pw_check()" autofocus/>
...
function pw_check(){
   ...
   $.ajax({
      ...
      data : {member_pw:$('#pw_check_leave').val() },
