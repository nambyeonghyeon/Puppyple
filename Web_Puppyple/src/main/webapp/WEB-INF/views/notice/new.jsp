	...
	<div id="new_content_wrap">
		...
		<form action="insert.no" method="post" enctype="multipart/form-data" >
			<table>
				<tr>
					<th>제목</th>
					<td><input type="text"  class="new_title_wrap" name='board_title' title='제목' class='chk' autofocus/></td> 
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea class="new_content_wrap"  name='board_content' title='내용' class='chk' ></textarea></td> 
				</tr>
				<tr>
					<th>첨부파일</th>
					<td class='left'>
						<label>
						<a><img src='imgs/select.png' class='file-img'   style="padding-left: 13px;"/></a>
