	...
	<div id="content_wrap">
		...
		<div id="community_menubar">
			...
			<div class="notice_title_div">
				<h1 class="title">공지사항<span class="small_title"><span class="small_title_l">|</span> notice</span></h1>
			</div>
		</div>
				...
				<div class="wrap">
					...
					<div id="search">
						<ul class="search_wrap">
							...
							<li class="search_eg2">
							<input type="text"  id="keyword" name="keyword" value="${page.keyword }" class="w-pw300">
				...
				<!-- 조회된 목록이 없을 경우 정보 표시 -->
					...
					<c:forEach items="${page.list}" var="vo">
						<ul>
							...
							<li class="w-pct50"  style="text-align: left; padding-left: 65px; color: #7a7a7a;"><a href='detail.no?id=${vo.id }'>${vo.board_title }</a></li>
