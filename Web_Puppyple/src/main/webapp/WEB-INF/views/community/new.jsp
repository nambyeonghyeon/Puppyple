		...
		<form action="insert.com" method="post" enctype="multipart/form-data" >
			<table>
				<tr>
					...
					<input type="text" name='board_title' title='제목' class='chk' id="board_title" maxlength="100" autofocus />
					<input type="text" placeholder="(0/ 100)" id="textLengthCheck" disabled="disabled">
					</div>
					</td> 
				</tr>
				<tr>
