...
<body>
	<div id="content_wrap">
		...
		<div id="community_menubar">
			...
			<div class="title_div">
				<h1 class="title">자유게시판<span class="small_title"><span class="small_title_l">|</span> community</span></h1>
			</div>
		</div>
		...
		<form action="list.com" method="post">
			...
			<div id='list-top'>
				<div class="wrap">
					<ul class="select">
						<li><select name='pageList' class='w-px75' onchange="$('form').submit()">
					...
					<c:forEach items="${page.list}" var="vo">
						<ul>
							...
							<li class="w-pct50"	style="text-align: left; padding-left: 70px; ">
								<a href='detail.com?id=${vo.id }'>${vo.board_title }</a></li>
