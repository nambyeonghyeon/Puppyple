...
<body>
	<div id="wrap">
		<form action="#" id="loginForm" name="loginForm" method="get">
			...
			<div id="idForm">
				...
				<input type="text" name="member_id" id="member_id" placeholder="ID를 입력하세요" />
		...
		<div id="link_find">
			<p><a href="id_find.find">아이디 찾기</a>&emsp;|&emsp;<a href="pw_find.find">비밀번호찾기</a></p>
		</div>
		...
		<div id="social_login">
			...
			<div class="naver_login">
				<button class="naver" onclick = "location.href = 'naverLogin' ">
					<img src="imgs/naver_login.png"/>
					<span>네이버로 로그인</span>
				</button>
			</div>
			<div class="kakao_login">
				<button class="kakao" onclick = "location.href = 'kakaoLogin' ">
					<img src="imgs/kakao_login.png"/></a>
					<span>카카오로 로그인</span>
				</button>
			</div>
		</div>
	...
	$(document).ready(function(){ $("#member_id").focus(); }); 
	function go_login() {
		// 아이디 입력값이 없으면 
		if($('#member_id').val() == ''){
			alert("아이디를 입력하세요!");
