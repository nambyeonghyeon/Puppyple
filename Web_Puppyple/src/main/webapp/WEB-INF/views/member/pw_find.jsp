				...
				<div id="search_id">
					<form action="find_pw_check" method="post" id="form">
						<div id="id_find">
							...
							<div>
								<input type="text" id="input_id" name="input_id" class="chk" title="아이디" autofocus />
							</div>
						</div>
						<div>
							<label for="input_email">이메일</label>
							<div>
								<input type="text" id="input_email" name="input_email" class="chk" title="이메일">
							</div>
						</div>
					</form>
					<div class="find_btn">
						<a onclick = 'if ( emptyCheck()  ) $("#form").submit()'class="btn_submit">확인</a>
