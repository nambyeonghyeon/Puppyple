...
<body>
	<div id="content_wrap">
		...
		<div id="community_menubar">
			...
			<div class="title_div">
				<h1 class="title">정보공유<span class="small_title"><span class="small_title_l">|</span> information</span></h1>
			</div>
		</div>
				...
				<!-- 조회된 목록이 없을 경우 정보 표시 -->
					...
					<c:forEach items="${page.list}" var="vo">
						<ul>
							...
							<li class="w-pct50"  style="text-align: left; padding-left: 65px; color: #7a7a7a;"><a href='detail.info?id=${vo.id }'>${vo.board_title }</a></li>
