...
public class InfoController {
	...
	@Autowired private InformationServiceImpl service;
	@Autowired private InformationPage page;
...
//댓글 삭제 처리 요청
	...
	public String update(InformationVO vo, MultipartFile file, 
...
//			vo.setWriter(member.getId());
			...
			return "redirect:list.info"; // 리턴 시 공지사항 목록 화면으로 이동 처리
		}
