...
public class InquiryController {
	...
	@Autowired private InquiryServiceImpl service;
	@Autowired private InquiryPage page;
	...
	public String update(InquiryVO vo, MultipartFile file, 
...
//			vo.setWriter(member.getId());
			...
			return "redirect:list.inq"; // 리턴 시 공지사항 목록 화면으로 이동 처리
		}
