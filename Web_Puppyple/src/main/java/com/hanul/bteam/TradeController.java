...
public class TradeController {
	...
	@Autowired private TradeServiceImpl service;
	@Autowired private TradePage page;
	...
	public String update(TradeVO vo, MultipartFile file, 
...
//			vo.setWriter(member.getId());
			...
			return "redirect:list.tra"; // 리턴 시 공지사항 목록 화면으로 이동 처리
		}
