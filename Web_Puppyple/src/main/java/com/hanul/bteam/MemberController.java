		...
		// 비밀번호찾기 결과 화면
			...
			public String pw_find_check(HttpServletRequest req, Model model, HttpServletResponse response){
				...
				if(pw != null) {
					...
					// 로그인하기위한 아이디 비번 지정
					mail.setAuthentication("wodyds", "mddfs3e");
					...
					try {
						...
						msg.append("<body>");
						msg.append("<a href='http://211.223.59.27:8002/bteam/'>"+"<img src='https://postfiles.pstatic.net/MjAyMTEyMjNfMTk4/MDAxNjQwMjMwMDY5MzM5.Mztt2JO30HomTl2V26WbOlvCdWvRLJRg26ug7qjl6aAg.bN92Upv8i8qDRtjDbtpVZDcjvmM0Oru1SZA3Bpqrq7Ug.PNG.wodyds/logo.png?type=w773'/></a>");
						msg.append("<hr>");
						msg.append("<p>비밀번호 찾기 결과입니다.</p>");
						msg.append("<p>회원님의 비밀번호는 "+"<b style='color: #6215e4; font-size:16px;'>"+pw+"</b>"+" 입니다.</p>");
...
//					msg.append("alert('회원가입을 축하드립니다.'); location='login'")
				...
				try {
					...
					msg1.append("<body>");
					msg1.append("<a href='http://211.223.59.27:8002/bteam/'>"+"<img src='https://postfiles.pstatic.net/MjAyMTEyMjNfMTk4/MDAxNjQwMjMwMDY5MzM5.Mztt2JO30HomTl2V26WbOlvCdWvRLJRg26ug7qjl6aAg.bN92Upv8i8qDRtjDbtpVZDcjvmM0Oru1SZA3Bpqrq7Ug.PNG.wodyds/logo.png?type=w773'/></a>");
					msg1.append("<hr>");
