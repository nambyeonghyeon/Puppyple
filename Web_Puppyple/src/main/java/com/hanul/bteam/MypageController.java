...
public class MypageController {
	...
	@Autowired private MypagePostPage page;
	@Autowired private MypagePage admin_page;
	...
	public String admin_delete(String member_id, HttpSession session) {
		...
		// 공지글에 대한 모든 정보 조회
		// MypageVO mypage = service.member_info_delete(member_id);
	...
	//20211206 Mypage 내가 좋아요한 글 보기 by JP
		...
		//20211206 Mypage 내가 쓴글 보기 by JP
